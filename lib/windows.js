...
const winBinPath = arch() === 'x64' ?
	path.join(__dirname, '../fallbacks/windows/clipboard_x86_64.exe').replace('app.asar', 'app.asar.unpacked') :
	path.join(__dirname, '../fallbacks/windows/clipboard_i686.exe').replace('app.asar', 'app.asar.unpacked');
